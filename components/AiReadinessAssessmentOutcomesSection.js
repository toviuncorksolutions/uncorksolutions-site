export default function AiReadinessAssessmentOutcomesSection() {
  return (
    <section id='ai-outcomes' data-gtm='section-outcomes' aria-labelledby='outcomes-title' className='bg-[#f1f2f4] py-16 px-6 md:px-16'>
      <div className='max-w-3xl mx-auto text-center'>
        ...
        <div className='my-10 mx-auto max-w-2xl p-6 bg-white rounded-xl shadow border' aria-label='Testimonial'>
          <div className='italic text-gray-700 text-lg mb-2'>
            &ldquo;That&rsquo;s different, and that&rsquo;s worth it. We&rsquo;ve seen enough AI maturity models. This is the first one that names owners, sets deadlines, and delivers a playbook we can actually execute&mdash;no fluff, no hype.&rdquo;
          </div>
        </div>
      </div>
    </section>
