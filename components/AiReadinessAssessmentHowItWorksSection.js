export default function AiReadinessAssessmentHowItWorksSection() {
  return (
    <section id='ai-how' data-gtm="section-how" aria-labelledby="how-title" className="bg-[#f1f2f4] py-16 px-6 md:px-16">
        ...
        <ol className="text-left space-y-8 max-w-2xl mx-auto">
          <li className="flex gap-4 items-start">
            ...
            <div>
              ...
              <div className="text-gray-700">20 minutes, fully confidential, enterprise-wide lens.</div>
            </div>
          </li>
          <li className="flex gap-4 items-start">
            <span className="text-3xl mt-1" aria-hidden="true">📊</span>
            <div>
              ...
              <div className="text-gray-700">Immediate radar chart, executive summary, risk profile.</div>
            </div>
          </li>
          <li className="flex gap-4 items-start">
            ...
            <div>
              ...
              <div className="text-gray-700">16 pages of action—mapped to owners, deadlines and operator tips.</div>
            </div>
          </li>
        </ol>
      </div>
