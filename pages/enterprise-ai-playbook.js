  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content="https://www.uncorksolutions.com/ai-readiness-playbook-1c.png"
        />
            ...
            __html: JSON.stringify(
              {
                ...
                '@graph': [
...

                  {
                    ...
                    primaryImageOfPage: {
                      '@type': 'ImageObject',
                      url: 'https://www.uncorksolutions.com/ai-readiness-playbook-1c.png',
                      width: 760,
                      height: 846,
                    },
                    speakable: {
        ...
        >
          ...
          >
            <Image
              ...
              src="ai-readiness-playbook-1c.png"
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left max-w-xl">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-6">
              ...
              your 25-page readiness plan&mdash;built for senior leaders who recognize AI demands
              strategic integration, not isolated experimentation.
            </p>
