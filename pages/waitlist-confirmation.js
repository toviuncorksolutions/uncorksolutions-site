...
export default function WaitlistConfirmation() {
  return (
    <>
      <Head>
        <title>Waitlist Confirmation – Uncork Solutions</title>
        <meta name="robots" content="noindex" />
      </Head>
      <main className="bg-[#E6FBF1] min-h-screen flex flex-col items-center justify-center text-center px-4">
        <img src="/logo.svg" alt="Uncork Solutions Logo" className="mx-auto mb-8 w-20 h-auto" />
        <h1 className="text-3xl font-bold mb-4">You're on the Waitlist!</h1>
        <p className="text-lg mb-6 max-w-xl mx-auto">
          Thank you for registering for early access to the Transformation Readiness Assessment.
          <br /><br />
