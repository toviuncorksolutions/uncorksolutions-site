...
export default function AIReadinessAssessment() {
  ...
  return (
    <>
      <Head>
        <title>Boardroom-Ready AI Readiness Assessment – Uncork Solutions</title>
        <meta
          name='description'
        ...
        <meta property='og:title' content='Boardroom-Ready AI Readiness Assessment – Uncork Solutions' />
        ...
        <meta name='twitter:title' content='Boardroom-Ready AI Readiness Assessment – Uncork Solutions' />
