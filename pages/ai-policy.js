  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn how Uncork Solutions uses AI responsibly—protecting client data, ensuring human oversight and transparency."
        />
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="AI Usage Policy & Responsible-AI Commitment | Uncork Solutions"
        />
        <meta
          property="og:description"
          content="How Uncork Solutions deploys AI securely, ethically and transparently."
        />
        ...
        <meta
          ...
          content="Our promise of responsible, secure and transparent AI."
        />
        <meta
          name="twitter:image"
          content="https://www.uncorksolutions.com/uncork-solutions-logo.png"
      ...
      >
        ...
        <section className="mb-8">
          <p>
            <span className="font-semibold text-blue-700">Uncork Solutions</span> is committed to
            using artificial intelligence (AI) tools responsibly, transparently, and securely—both
            for internal work and in client engagements.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            This policy outlines our approach to the ethical, secure, and transparent use of AI
            technologies, reflecting our values and obligations to clients and partners.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            We may use generative AI tools (e.g., OpenAI, Gemini, Copilot) to support research,
            content drafting, code generation, and workflow automation.
          </p>
          <ul className="list-disc list-inside ml-4 mt-2 text-gray-700 space-y-1">
            <li>
              AI tools are used to increase efficiency, creativity, and insight—not to replace human
              judgment.
            </li>
            <li>
              All AI-generated content and recommendations are reviewed and validated by a human
          ...
          <ul className="list-disc list-inside ml-4 mt-2 text-gray-700 space-y-1">
            <li>
              <span className="font-semibold">
                No client confidential data, personal information, or sensitive documents are ever
                entered into public AI tools or platforms without explicit consent and appropriate
                safeguards.
              </span>
            </li>
            <li>
              Only AI services with robust security, privacy, and compliance standards may be used
              for projects involving client or sensitive data.
            </li>
            <li>
              We maintain internal controls to ensure data is handled securely throughout the AI
              lifecycle.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>We recognize that AI systems may introduce bias or errors. Our commitments:</p>
          <ul className="list-disc list-inside ml-4 mt-2 text-gray-700 space-y-1">
            <li>
              AI-generated outputs are always reviewed for accuracy, relevance, and fairness before
              use in client deliverables.
            </li>
            <li>
              We do not rely on AI for any final decision-making or critical analysis without human
              validation.
            </li>
            <li>
              We actively monitor for potential bias or unintended consequences and will take
        ...
        <section className="mb-8">
          ...
          <p>We are transparent about our use of AI:</p>
          <ul className="list-disc list-inside ml-4 mt-2 text-gray-700 space-y-1">
            <li>
              Clients are informed when AI-generated content or insights contribute materially to
              deliverables.
            </li>
            <li>
              We will answer any questions about our AI practices and decision-making process upon
              request.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>We monitor legal, regulatory, and best-practice developments in AI.</p>
          <ul className="list-disc list-inside ml-4 mt-2 text-gray-700 space-y-1">
            <li>
              This policy is reviewed annually, or sooner if regulations or technology change.
            </li>
            <li>We strive to ensure our AI practices remain current and compliant.</li>
          </ul>
        </section>
